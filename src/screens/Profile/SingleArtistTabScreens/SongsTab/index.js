...
const SingleArtistProfileSongs = () => {
  ...
  const {loading, error, medias: artistMedias} = getSingleArtistMedias;
    ...
    return (
      <View style={styles.container}>
        <Text
          ...
          Artist hasn't uploaded any song yet.
        </Text>
      </View>
    );
  } else if (loading) {
...
export default SingleArtistProfileSongs;
